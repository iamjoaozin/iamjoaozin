<div align="center">
  <h1>João Victor (iamjoaozin)</h1>
  <p><strong>Desenvolvedor Full Stack, Automação de Sistemas & Engenharia de Software</strong></p>

  <p>
    <a href="https://www.linkedin.com/in/joao-victor-621405224/" target="_blank">
      <img src="https://img.shields.io/badge/LinkedIn-João_Victor-0A66C2?style=for-the-badge&logo=linkedin" alt="LinkedIn" />
    </a>
    <a href="https://wa.me/5587991695672" target="_blank">
      <img src="https://img.shields.io/badge/WhatsApp-87_99169--5672-25D366?style=for-the-badge&logo=whatsapp" alt="WhatsApp" />
    </a>
    <a href="mailto:j33061393@gmail.com">
      <img src="https://img.shields.io/badge/E--mail-j33061393%40gmail.com-EA4335?style=for-the-badge&logo=gmail" alt="Email" />
    </a>
  </p>
</div>
...
Atuo no desenvolvimento de software cobrindo desde aplicações web reativas (PWAs e sistemas de agendamento) até automação em Python, gerenciamento de dados e engenharia reversa/desenvolvimento de baixo nível em Assembly e C++.

- **Aplicações Web & PWA:** Construção de interfaces em React.js, gestão de estado, integração com Firebase (Firestore/Auth) e suporte a PWA com notificações push offline-first.
- **Automação & Backend:** Automação de processos, painéis de controle em tempo real, manipulação de proxies e pipelines de dados em Python.
- **Engenharia Reversa & Low-Level:** Desenvolvimento em Assembly 65816 para modificação de ROMs (Super Mario World, PIXI custom sprites), rotinas de som e pontes de comunicação via Lua/C++ para emuladores (Mesen).
...
| :--- | :--- |
| **Frontend & Web** | React.js, Vite, PWA (Service Workers, Push API), Modern CSS |
| **Backend & Cloud** | Python (FastAPI), Node.js, Firebase (Firestore, Auth), REST APIs |
| **Baixo Nível & Modding** | Assembly 65816 (PIXI, Opcodes 65c816), C/C++, Lua Scripting |
| **Ferramentas** | Git, Lunar Magic, PIXI, AddmusicK, Ghidra, Mesen Emulator API |
